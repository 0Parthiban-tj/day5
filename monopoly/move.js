...
var arrdiv=[box1,box2,box3,box4,box8,box12,box16,box15,box13,box9,box5];
...
function changeposition1(old , current)
{
    ...
    let template='<img src="./images/b*.png" id="img11" alt="red" style="widht:"';
...
function changeposition2(old , current)
{
    ...
    let template='<img src="./images/b*.png" id="img11" alt="red" style="widht:"';
    console.log("person2 play",perso2[1]);
